...
export const AuthProvider = ({ children }) => {
    ...
    const authContext = useContext(AuthContext); //AuthContext se data lene ki koshish


    const [userData, setUserData] = useState(authContext);//User ka data store karne ke liye state
